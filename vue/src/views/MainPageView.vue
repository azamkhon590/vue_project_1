...
<template>
    ...
    <div class="service_area section__padding">
        <div class="container">
            <div class="row justify-content-center ">
                <div class="col-lg-4 col-md-6">
                    <div class="single_service d-flex align-items-center ">
              ...
              <div class="coures_wrap d-flex">
                <div class="single_wrap">
                  ...
                  <p>
                    ...
                    tpor incididunt ut piscing vcs.
                  </p>
                  <a href="#" class="boxed-btn5">Apply NOw</a>
                </div>
                <div class="single_wrap">
        ...
        <div class="col-lg-10">
          <div class="single_event d-flex align-items-center">
            ...
            <div class="event_info">
              ...
              <p>
                <span> <i class="flaticon-clock"></i> 10:30 pm</span>
                <span> <i class="flaticon-calendar"></i> 21Nov 2020 </span>
                <span> <i class="flaticon-placeholder"></i> AH Oditoriam</span>
              </p>
            </div>
          </div>
          <div class="single_event d-flex align-items-center">
